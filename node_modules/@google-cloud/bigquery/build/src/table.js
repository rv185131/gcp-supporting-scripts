...
class Table extends common.ServiceObject {
    ...
    async _createLoadJob(source, metadata) {
        ...
        if (typeof source === 'string') {
            ...
            const detectedFormat = FORMATS[path
                .extname(source)
                .substr(1)
                .toLowerCase()];
            ...
            const jobResponse = (await p_event_1.default(jobWritable, 'job'));
    ...
    getRows(optionsOrCallback, cb) {
        ...
        const onComplete = (err, rows, nextQuery, resp) => {
            ...
            rows = _1.BigQuery.mergeSchemaWithRows_(this.metadata.schema, rows || [], wrapIntegers, options.selectedFields ? options.selectedFields.split(',') : []);
